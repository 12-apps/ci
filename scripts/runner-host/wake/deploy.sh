...
# (future-pay-ci), INSTANCE_TYPES (eight 8-vCPU x86 types, spread by the fleet),
...
types="${INSTANCE_TYPES:-c7a.2xlarge,c6a.2xlarge,c7i.2xlarge,c6i.2xlarge,m7a.2xlarge,m6a.2xlarge,m7i.2xlarge,m6i.2xlarge}"
